...
#if 1//ADI Joshua Yoon for interfacing ADPD
static struct gpiomux_setting gpio_adpd_i2c_config = {
	.func = GPIOMUX_FUNC_3,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
};
#if 1
static struct gpiomux_setting gpio_adpd_i2c_susp_config = {
	.func = GPIOMUX_FUNC_3,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
};
#endif
static struct gpiomux_setting gpio_adpd_gpio_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,//GPIOMUX_DRV_8MA //ADI Joshua Yoon for interfacing ADPD
	.pull = GPIOMUX_PULL_DOWN,//ADI Joshua Yoon for interfacing ADPD
};
#endif
...
static struct msm_gpiomux_config msm_blsp_configs[] __initdata = {
	...
	{                           /* NFC */
		...
		.settings = {
#if 1//ADI Joshua Yoon for interfacing ADPD
			[GPIOMUX_ACTIVE] = &gpio_adpd_i2c_config,
			[GPIOMUX_SUSPENDED] = &gpio_adpd_i2c_susp_config,
#else
			[GPIOMUX_SUSPENDED] = &gpio_i2c_config,
#endif
		},
...
#if 1//ADI Joshua Yoon for interfacing ADPD
	{
		.gpio	   = 59,		/* NFC_IRQ */
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_adpd_gpio_config,
			[GPIOMUX_SUSPENDED] = &gpio_adpd_gpio_config,
		},
	},
#endif
...
#if 1//ADI Joshua Yoon for interfacing ADPD
/*
To 8074 Sensor Connector
#1 - Yellow(BLSP12_I2C_SDA)
#3 - Blue(BLSP12_I2C_SCL)
#9 - Black(ground)
#2 - Red(GPIO73-ACCEL1_INT1_N) or #4 - Red(GPIO65-ACCEL1_INT2) or #6 - Red(GPIO66-GYRO_INT1)
*/
	{
		.gpio      = 87,		/* BLSP12_I2C_SDA */
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_adpd_i2c_config,
			[GPIOMUX_SUSPENDED] = &gpio_adpd_i2c_susp_config,
		},
